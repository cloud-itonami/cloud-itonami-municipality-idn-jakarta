# cloud-itonami-municipality-idn-jakarta

Municipal-ordinance compliance catalog for **Jakarta** — the
THIRTY-FOURTH municipality-level entry alongside
...
Jakarta REMAINS the official capital, not Nusantara (the planned new
capital in East Kalimantan, whose transition remains incomplete and
is targeted only as a "political capital" by 2028) — verified
independently rather than assumed, given the ongoing, actively-litigated
relocation process.

## Scope

A **read-only reference/archive** catalog — not an Advisor⊣Governor
actuation actor. It proposes or executes nothing on DKI Jakarta's
behalf.
...
Both entries directly confirmed via `jdih.jakarta.go.id` (Jakarta's
own Legal Documentation and Information Network): **Governor
Regulation Number 101 of 2017** (foreign-mission local tax exemption,
year-only date) and **Regional Regulation Number 4 of 2019** (waste
management, established 23 September 2019).
...
festivals and heritage sites for Jakarta:
...
itself remains DKI Jakarta's; this repo stores only citation metadata
